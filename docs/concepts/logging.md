...
2.  **Cloud Providers**: Connectors for buffering and sending logs to services like **Loki** or **OpenTelemetry Logs**. This ensures you can monitor your workflows in production without losing data.
